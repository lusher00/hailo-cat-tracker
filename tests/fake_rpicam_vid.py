...
A red block ("cat") follows a slow path and a blue block ("person") sits still,
so the tracker has both a moving and a static object to hold IDs on.
Deliberately non-square (1280x720) so letterbox padding is exercised.
"""
...
while True:
    ...
    cv2.putText(frame, "SYNTHETIC", (W // 2 - 190, H - 40),
